...
def create_sat_netcdf_example_notebook(ndvi, ndbi, ndwi, albedo, lst, lat_grid_clip_sentinel, lon_grid_clip_sentinel, city):
    ...
    NDVI = nc_ds.createVariable('NDVI', 'f4', ('lon', 'lat',))
    NDBI = nc_ds.createVariable('NDBI', 'f4', ('lon', 'lat',))
    NDWI = nc_ds.createVariable('NDWI', 'f4', ('lon', 'lat',))
    Albedo = nc_ds.createVariable('Albedo', 'f4', ('lon', 'lat',))
    LST = nc_ds.createVariable('LST', 'f4', ('lon', 'lat',))
...
def create_sat_netcdf(ndvi, ndbi, ndwi, albedo, height, lst, lat_grid_clip_sentinel, lon_grid_clip_sentinel, city):
    ...
    NDWI = nc_ds.createVariable('NDWI', 'f4', ('lon', 'lat',))
    Albedo = nc_ds.createVariable('Albedo', 'f4', ('lon', 'lat',))
    Height = nc_ds.createVariable('Height', 'f4', ('lon', 'lat',))
    LST = nc_ds.createVariable('LST', 'f4', ('lon', 'lat',))
